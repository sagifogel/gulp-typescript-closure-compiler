module.exports = (function () {
    ...
    function CompilationStream(compilationOptions, pluginOptions) {
        ...
        this.outFile = compilationOptions.outFile = tryNormalizePath(compilationOptions.outFile || compilationOptions.out);
    }
    ...
    CompilationStream.prototype._flush = function (cb) {
        ...
        var compiler = new Compiler(this.compilationOptions, inputFiles);
